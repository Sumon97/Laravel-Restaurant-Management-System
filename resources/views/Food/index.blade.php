        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <button style="float: right; margin: -58px 0px 0px 0px;" type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add new Food Item</button>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <!-- start form from here -->
                        <form role="form text-left" method="Post" action="/Food" enctype="multipart/form-data">
                           @csrf
                          <div class="row">
                          <div class="col-md-6">
